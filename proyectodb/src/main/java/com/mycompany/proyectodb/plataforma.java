...
public class plataforma {
    ...
    String fecha_lanzamiento_plataforma;
    ...
    public String getFecha_lanzamiento_plataforma() {
        return fecha_lanzamiento_plataforma;
    }

    public void setFecha_lanzamiento_plataforma(String fecha_lanzamiento_plataforma) {
     ...
     public void inserta_plataforma(JTextField nombre_plataforma, JTextField modelo_recibida, JTextField fecha_recibida)
    {
            ...
            setFecha_lanzamiento_plataforma(fecha_recibida.getText());
      
             coneccion objetoConexion = new coneccion();
             String consulta=" INSERT INTO plataforma(nombre_plataforma,modelo,fecha_lanzamiento) \n" +
"      VALUES (?,?,?);" ; //donde va a estar guardada la consulta 
             ...
             try{
                 ...
                 cs.setString(3,getFecha_lanzamiento_plataforma());
